      ...
      <div class="row node">
        ...
        <div class="news col-md-12 alpha omega">
          <div class="pull-right">
              <div class="col-sm-3">
                 <button class="btn btn-info btn-sm"><a href="seat_gold.php">Gold</button></a>
              </div>
              <div class="col-sm-3">
                 <button class="btn btn-success btn-sm"><a href="seat_silver.php">Silver</button></a>
              </div>
              <div class="col-sm-3">
                 <button class="btn btn-primary btn-sm"><a href="seat_silver.php">Premium</button></a>
              </div>
              <div class="col-sm-3">
                 <button class="btn btn-danger btn-sm"><a href="seat_silver.php">Platinum</button></a>
              </div>
              <div class="col-sm-3">
                 <button class="btn btn-default btn-sm"><a href="seat_silver.php">Regular</button></a>
              </div>
          </div>
