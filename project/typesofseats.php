      ...
      <div class="row node">
        ...
        <div class="news col-md-12 alpha omega">
          <div class="pull-right">
            ...
            <h2 style="color: red;">If you want you have to click on each seat category option and their will be show each seats package & price & discount.</h2>
            <table border="1px;">
              <tr>
                <th width="20%" style="color: red; background: silver; text-align: center;">Serial No.</th>
                <th width="20%" style="color: red; background: silver; text-align: center;">Seat Category</th>
              </tr>
              <tr>
