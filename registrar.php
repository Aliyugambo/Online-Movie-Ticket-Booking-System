...
<script type="text/javascript">
  ...
  function validFormInfo(){
        ...
        if (pnumber.length == 0) {
          ...
          var errors = document.getElementById('errors');
          errors.style.color = "red";
          errors.innerHTML = "Phone number must input 11 digit";
          pnumber2 = document.getElementById('pnumber');
          pnumber2.style.backgroundColor="LIGHTCORAL";
          return false;
          }
                ...
                <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav pull-right">
                    ...
                    <li><a href="massuser.php"><i class="fas fa-user"></i>Profile</a></li>
                            <li><a href="userlogin.php"><i class="fas fa-sign-out-alt"></i>Log in</a></li>
                            <?php 
...
<form method="post" action="" name="myform" onSubmit="return validFormInfo()">
          ...
          <div class="abcd">
              <p>Already registred?<a class="dd" href="userlogin.php" value="Login">Login</a></p>
		      </div>
